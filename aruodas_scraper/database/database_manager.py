"""Simplified database manager for handling SQL database operations with real estate data."""
...
def get_available_driver():
    """Find the first available SQL Server ODBC driver."""
...
def get_streamlit_connection():
    ...
    try:
        # Use Streamlit's connection management with configuration
        conn = st.connection(
            "azure_sql",
            type="sql",
            url=f"mssql+pyodbc:///?odbc_connect={quote_plus(get_connection_string())}",
